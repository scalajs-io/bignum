...
lazy val publishingSettings = Seq(
  ...
  pomExtra :=
    <url>https://github.com/scalajs-io/bignum</url>
      <licenses>
        <license>
      ...
      <scm>
        <connection>scm:git:github.com/scalajs-io/bignum.git</connection>
        <developerConnection>scm:git:git@github.com:scalajs-io/bignum.git</developerConnection>
        <url>github.com/scalajs-io/bignum.git</url>
      </scm>
      <developers>
        <developer>
          <id>ldaniels528</id>
